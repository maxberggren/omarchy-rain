...
Item {
  ...
  QtObject {
    ...
    readonly property real rainTurn: view.num(view.cfg.rain.turn, 1.0)
    ...
    readonly property real rimDark: view.num(view.cfg.optics.rimDark, 0.7)
    ...
    readonly property vector4d lightDir: { var l = view.vec3(view.cfg.optics.light, [-0.45, -0.7, 0.75]); return Qt.vector4d(l.x, l.y, l.z, view.num(view.cfg.optics.reflection, 0.3)); }
    readonly property vector4d reflectColor: { var c = view.vec3(view.cfg.optics.reflectionColor, [0.85, 0.9, 1.0]); return Qt.vector4d(c.x, c.y, c.z, view.num(view.cfg.optics.reflection, 0.3)); }
  ...
  readonly property real dropsFps: Math.max(0, Math.min(60, view.num(view.cfg.drops.fps, 10)))
  Timer {
